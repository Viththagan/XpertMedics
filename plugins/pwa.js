...
$(document).ready(function(){      
    ...
    setTimeout(function(){
        $('.pwa-dismiss').on('click',function(){
			...
			$.post(config_url+'update.php',{form_submit:'installed',installed:0});
    ...
    if (isMobile.Android()) {
        ...
        $.post(config_url+'update.php',{form_submit:'device',device:'Android'});
        ...
        window.addEventListener('appinstalled', (evt) => {
			...
			$.post(config_url+'update.php',{form_submit:'installed',installed:1});
        });
    }  
    ...
    if (isMobile.iOS()) {
        if(!isInWebAppiOS){
            console.log('iOS Detected');
			 $.post(config_url+'update.php',{form_submit:'device',device:'iOS'});
